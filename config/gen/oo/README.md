...
2. 一轮 sample smoke 已写到 [outputs/smoke/oo/summary.json](outputs/smoke/oo/summary.json)。
...
这些结构现在都在本仓库的 [config/gen/oo/model.py](config/gen/oo/model.py) 中以 TAAC 当前 batch 契约重写。
