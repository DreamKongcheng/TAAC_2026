...
Converted figures now live under img/ and are referenced directly from this markdown file.
...
![Figure 1: InterFormer architecture overview.](img/arch.png)
...
![Figure 3: Study on information aggregation.](img/aggregation.png)
...
![Figure 4: Attention map on TaobaoAds.](img/attn.png)
...
![Figure 5: Ablation study on InterFormer.](img/ablation.png)
...
![Figure 6a: Feature scaling.](img/feature_scaling.png)
...
![Figure 6b: Model scaling.](img/model_scaling.png)
