...
Converted figures live under img/ and are referenced directly from this markdown file.
...
![Figure 1: Architectural comparison between encode-then-interaction and OneTrans.](img/compare_all-1.png)
...
![Figure 2: OneTrans system architecture and block design.](img/onetrans_all-1.png)
...
![Figure 3a: FLOPs vs delta UAUC trade-off.](img/tradeoff_scaling_singlecol-1.png)

Figure 3a. Performance-compute trade-off: training FLOPs versus delta UAUC.

![Figure 3b: Scaling law on a log scale.](img/scaling_law_singlecol_bw-1.png)
